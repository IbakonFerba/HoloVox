...
// ############################### Constructor ###################################
WireCube::WireCube(float const xPos, float const yPos, float const zPos, float const xSize, float const ySize, float const zSize, float const xRot, float const yRot, float const zRot) : m_dimensions(xSize, ySize, zSize)
{
...
// ############################### Functionality ###################################
void WireCube::draw(HoloVox &rDisplay) const
{
    ...
    drawLine(transformedPoints[1], transformedPoints[5], rDisplay);
    drawLine(transformedPoints[2], transformedPoints[6], rDisplay);
    drawLine(transformedPoints[3], transformedPoints[7], rDisplay);
}